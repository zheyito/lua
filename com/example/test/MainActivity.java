...
public class MainActivity extends e {
  ...
  static {
    StubApp.interface11(713);
  }
  
  @OnClick
  public void onClick(View paramView) {
    if (paramView.getId() == 2131165268)
      if (this.btn_start.getText().toString().contains("开启")) {
        this.btn_start.setText("关闭");
        if (!this.p) {
          Intent intent = new Intent((Context)this, FloatService.class);
          a a = new a();
          this.q = a;
  ...
  public static class a implements ServiceConnection {
    public void onServiceConnected(ComponentName param1ComponentName, IBinder param1IBinder) {
      FloatService floatService = ((FloatService.a)param1IBinder).a;
      if (!floatService.c) {
        floatService.c = true;
...
/* Location:              E:\浏览器下载\AndroidKiller_v1.3.12018整合版By吾爱论坛昨夜星辰2012\projects\锦衣卫_1.1.4\ProjectSrc\smali\!\com\example\test\MainActivity.class
